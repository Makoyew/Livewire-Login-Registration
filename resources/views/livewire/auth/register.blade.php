                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h1 class="text-center mb-0 font-weight-bold text-black">Register</h1>
                            </div>
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model="password_confirmation" type="password" class="form-control" id="password_confirmation" placeholder="Confrim password">
                                    </div>
