<div>
    <div class="">
        ...
        @endif
        <div class="row mx-auto mt-3 mb-3 d-flex justify-content-between">
            <div class="col-md-3 text-white mb-5 mt-4">
                <div class="card" style="height: 540px; background-color:rgb(124, 114, 124)">
                    <div class="mt-4 mx-4">
                    ...
                    <div class="ms-3">
                        ...
                        <input type="range" class="form-control-range" id="customRange2" min="0" max="10000" style="width: 250px;" wire:model='byRate'>
                        <span class="form-text">P{{ $this->byRate }}</span>
                    </div>
                    <div class="ms-3" style="width: 250px;">
                    ...
                    <button class="btn btn-primary col-md-6 mt-2 ms-auto me-3 mt-4" wire:click='resetFilters' type='button'>
                        Reset
                    </button>
            ...
            <div class="col-md-8">
                <div class="d-flex justify-content-between mx-auto">
                    <button type="button" class="btn btn-primary me-5 mb-3" data-bs-toggle="modal"
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="image-input" wire:model="image">
                                            @if ($image)
                                              <div class="mt-2">
                                                <img src="{{ $image->temporaryUrl() }}" alt="Photo Preview" style="width: 100px; height: 100px;">
                                              </div>
                                            @endif
                                            @error('image')
                                          ...
                                          <div class="mb-3">
                                            <label for="bandName-input" class="form-label">Band Name:</label>
                                            <input type="text" class="form-control" id="bandName-input" wire:model="bandName">
                                            @error('bandName')
                                              <div class="mt-2 text-danger">{{ $message }}</div>
                                            @enderror
                                          </div>
                                          <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="location-input" wire:model="location">
                                            @error('location')
                                              <div class="mt-2 text-danger">{{ $message }}</div>
                                            @enderror
                                          </div>
                                        ...
                                        <div class="col-md-6">
                                          <div class="mb-3">
                                            <label for="rate-input" class="form-label">Rate:</label>
                                            <input type="number" class="form-control" id="rate-input" wire:model="rate">
                                            @error('rate')
                                              <div class="mt-2 text-danger">{{ $message }}</div>
                                            @enderror
                                          </div>
                                          <div class="mb-3">
                                            ...
                                            <select class="form-select" id="genre-select" wire:model="genre">
                                          ...
                                          <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description-textarea" rows="4" wire:model="description"></textarea>
                                            @error('description')
                                              <div class="mt-2 text-danger">{{ $message }}</div>
                                            @enderror
                                          </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body bg-primary">
                                        ...
                                        <p class="card-text fst-italic mb-1">Location: <span class="fw-bold">{{ $band->location }}</span></p>
                                        <p class="card-text fst-italic mb-1">Rate: <span class="fw-bold">P{{ $band->rate }}</span></p>
                                        <p class="card-text fst-italic mb-0">Genre: <span class="fw-bold">{{ $band->genre }}</span></p>
                                      </div>
